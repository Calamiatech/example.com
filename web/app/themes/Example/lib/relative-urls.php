 ...
 */
function example_root_relative_url($input) {
...
if (example_enable_root_relative_urls()) {
  ...
  add_filters($root_rel_filters, 'example_root_relative_url');
}
