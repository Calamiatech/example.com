...
if (current_theme_supports('bootstrap-gallery')) {
  ...
  add_shortcode('gallery', 'example_gallery');
 ...
 */
function example_attachment_link_class($html) {
  $postid = get_the_ID();
  $html = str_replace('<a', '<a class="thumbnail img-thumbnail"', $html);
  return $html;
}
add_filter('wp_get_attachment_link', 'example_attachment_link_class', 10, 1);
